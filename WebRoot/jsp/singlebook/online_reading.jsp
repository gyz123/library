	...
	<div class='pager' style="position:fixed;bottom:0;left:0;right:0">
		<div class="pager-left">
			<div class="pager-first">
				<a class="pager-nav" 
					href="/library/onlineReading.action?bookno=${bookno }&weid=${weid }&chapter=1">
				首章
				</a>
			</div>
			<div class="pager-pre">
				<a class="pager-nav" 
					href="/library/onlineReading.action?bookno=${bookno }&chapter=${pagenum-1 }&weid=${weid }">
				上一章
				</a>
			</div>
		</div>
		...
		<div class="pager-right">
			...
			<div class="pager-end">
				<a class="pager-nav" 
					href="/library/onlineReading.action?bookno=${bookno }&weid=${weid }&chapter=35">
				终章
				</a>
			</div>
		</div>
